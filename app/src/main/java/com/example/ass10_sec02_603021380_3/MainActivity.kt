package com.example.ass10_sec02_603021380_3
...
import kotlinx.android.synthetic.main.inset_layout.view.*
...
class MainActivity : AppCompatActivity() {
    ...
    fun addStudent(v: View){
        val mDialogView = LayoutInflater.from(this).inflate(R.layout.inset_layout,null)
